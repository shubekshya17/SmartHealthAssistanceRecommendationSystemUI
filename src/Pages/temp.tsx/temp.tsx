    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#f9fafb", padding: "20px" }}>
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <h3 style={{ fontWeight: "600", margin: "0 0 4px 0" }}>{hospital.name}</h3>
          <p style={{ color: "#6b7280", margin: 0, fontSize: "14px" }}>{hospital.address}</p>
        </div>
        ...
        {step === 1 && (
          <div style={{
            ...
            <h2 style={{ fontSize: "24px", fontWeight: "bold", margin: "0 0 8px 0" }}>Select a Doctor</h2>
            <p style={{ color: "#6b7280", margin: "0 0 24px 0" }}>Choose your doctor</p>
            
            {/* Specialty Filter Dropdown */}
            <div style={{ marginBottom: "24px" }}>
              <label style={{ display: "block", marginBottom: "8px", fontWeight: "500" }}>Filter by Specialty</label>
              <select
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px", marginBottom: "24px" }}>
              {filteredDoctors.length === 0 ? (
                <div style={{
                  ...
                  <p style={{ color: "#6b7280", margin: 0 }}>No doctors found for the selected specialty.</p>
                </div>
              ) : (
                filteredDoctors.map((doctor) => (
                  <div
                    ...
                    style={{
                      padding: "16px",
                      borderRadius: "8px",
                      border: selectedDoctor === doctor.id ? "2px solid #69b3b4" : "2px solid #e5e7eb",
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                      ...
                      <div style={{ flex: 1 }}>
                        <h3 style={{ fontWeight: "600", margin: "0 0 4px 0" }}>{doctor.name}</h3>
        ...
        {step === 2 && (
          <div style={{
            ...
            <h2 style={{ fontSize: "24px", fontWeight: "bold", margin: "0 0 8px 0" }}>Choose Date & Time</h2>
            <p style={{ color: "#6b7280", margin: "0 0 24px 0" }}>Select your appointment slot</p>
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              <label style={{ display: "block", marginBottom: "8px", fontWeight: "500", marginTop: "16px" }}>Available Time Slots</label>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
                {["09:00 AM", "10:00 AM", "11:00 AM", "02:00 PM", "03:00 PM", "04:00 PM"].map((time) => (
                  <button
                    ...
                    style={{
                      padding: "8px",
                      border: selectedTime === time ? "2px solid #69b3b4" : "1px solid #d1d5db",
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              ...
              <button
                style={{
                  flex: 1,
                  backgroundColor: selectedDate && selectedTime ? "#69b3b4" : "#9ca3af",
                  color: "white",
                  border: "none",
                  padding: "12px",
                  borderRadius: "8px",
        ...
        {step === 3 && (
          <div style={{
            ...
            <h2 style={{ fontSize: "24px", fontWeight: "bold", margin: "0 0 8px 0" }}>Patient Details</h2>
            <p style={{ color: "#6b7280", margin: "0 0 24px 0" }}>Enter your information</p>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px", marginBottom: "24px" }}>
              ...
              <div>
                <label style={{ display: "block", marginBottom: "4px", fontWeight: "500" }}>Symptoms</label>
                <textarea
